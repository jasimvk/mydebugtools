        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-1">
              {filteredCategories[0]?.tools.map((tool) => {
            ...
            <div className="hidden md:flex items-center space-x-2">
              <a
                ...
                className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-300 hover:text-white hover:bg-[#2a2a2a] rounded-md transition-colors"
              >
            ...
            <button
              ...
              className="md:hidden p-2 rounded-md text-gray-300 hover:text-white hover:bg-[#2a2a2a]"
            >
          ...
          <div className="md:hidden border-t border-gray-800">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-[#2a2a2a] hover:text-white"
              >
